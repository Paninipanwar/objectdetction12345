...
function draw() {
  ...
  for (let i = 0; i < detections.length; i++) {
    ...
    if (object.label !== 'bisleri' && object.label !== 'orange' && object.label !== 'banana') {
      continue; // Skip the iteration for labels other than 'bisleri', 'orange', or 'banana'
    }
